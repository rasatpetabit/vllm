...
# --- Restored legacy pythonic-tool string helpers (strategy D step 3c) ---
# Restored from the pre-absorb implementation (a818672184) for base consumers
# (lfm2_tool_parser, test_utils, abstract_tool_parser, cohere_command_tool_parser)
# alongside the absorbed 01ecc8e4-era API.
